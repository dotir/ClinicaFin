 ...
 * @author Dell
 */
@WebServlet(name = "SeleccionarDistrito", urlPatterns = {"/SeleccionarDistrito"})
public class SeleccionarDistrito extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            p = d.obtenerDistrito(Integer.parseInt(tipo));
