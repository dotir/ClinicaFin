 ...
 * @author Dell
 */
@WebServlet(name = "SeleccionarCostoEspecialidad", urlPatterns = {"/SeleccionarCostoEspecialidad"})
public class SeleccionarCostoEspecialidad extends HttpServlet {
...
//        if(tipo.equals("especialidad")){  
            ...
            int p = 0;
            p = d.obtenerCostoEspecialidad(Integer.parseInt(tipo));
