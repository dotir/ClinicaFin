 ...
 * @author Dell
 */
    @WebServlet(name = "SeleccionarTipoExamen", urlPatterns = {"/SeleccionarTipoExamen"})
public class SeleccionarTipoExamen extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            p = d.obtenerExamen(Integer.parseInt(tipo));
