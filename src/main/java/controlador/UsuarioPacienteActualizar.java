 ...
 * @author Dell
 */
@WebServlet(name = "UsuarioPacienteActualizar", urlPatterns = {"/UsuarioPacienteActualizar"})
public class UsuarioPacienteActualizar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String idDoctor=request.getParameter("idPersona");
        String nombre=request.getParameter("Nombre");
        String apellidop=request.getParameter("ApellidoP");
        String apellidom=request.getParameter("ApellidoM");
        String dni=request.getParameter("NroDocumento");
        String fecha_nacimiento=request.getParameter("FechaNac");
        String correo=request.getParameter("correo");
        String direccion =request.getParameter("Direccion");
        DaoUsuario objagregarpa= new DaoUsuario();
        persona objPaciente = new persona(Integer.parseInt(idperson),nombre,apellidop,apellidom,fecha_nacimiento,dni,direccion,correo);
        objagregarpa.ActualizarPaciente(objPaciente);
...
//        objagregarpa.ActualizarU(objPersona, contraseña, ncelular);
        ...
        response.sendRedirect("bpaciente.jsp");
