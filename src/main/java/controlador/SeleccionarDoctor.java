 ...
 * @author Dell
 */
@WebServlet(name = "SeleccionarDoctor", urlPatterns = {"/SeleccionarDoctor"})
public class SeleccionarDoctor extends HttpServlet {
...
//        if(tipo.equals("especialidad")){  
            ...
            p = d.obtenerDoctorEspecialidad(Integer.parseInt(tipo));
