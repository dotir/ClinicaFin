 ...
 * @author Dell
 */
    @WebServlet(name = "SeleccionarDepartamento", urlPatterns = {"/SeleccionarDepartamento"})
public class SeleccionarDepartamento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            p = d.obtenerProvincia(Integer.parseInt(tipo));
