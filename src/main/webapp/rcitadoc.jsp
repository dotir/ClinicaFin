                                        ...
                                        <form id="registrocita" name=formcita method="POST" action="CitaRegistro">
                                            ...
                                            <div class="form-group">
                                                <select name="doctor" class="form-control" aria-label="Default select example">
                                                   ...
                                                   <% for (int i = 0; i < obj.obtenerLocal().size(); i++) {    
                                                    %>
                                                    <option value="<%=i%>"><%= obj.obtenerLocal().get(i) %></option>
                                                    <% } %>
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <select name="local" class="form-control" aria-label="Default select example">
                                           ...
                                           <div class="input_wrap common_date_picker mb_20">
                                                <input type="datetime" class="input_form" name="fecha" id="start_datepicker" placeholder="Ingrese la fecha de la cita">
                                            </div>
                                            <div class="input_wrap common_date_picker mb_20">
                                                <input placeholder="Seleccionar hora inicio" type="time" id="input_starttime" class="form-control timepicker">
                                               
                                            </div>
                                            
                                            <div class="input_wrap common_date_picker mb_20">
                                                <input placeholder="Seleccionar hora fin" type="time" id="input_starttime" class="form-control timepicker">
                                            </div>
