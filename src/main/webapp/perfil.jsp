    ...
    <body class="crm_body_bg">
        ...
        <nav class="sidebar">
            ...
            <ul id="sidebar_menu">
             ...
             telefono tel = (telefono) session.getAttribute("datostelefono");
             usuario usu = (usuario) session.getAttribute("datoscontrasena");%>
                        ...
                        <div class="col-lg-12">
                            <div class="white_box mb_30">
                                ...
                                <div class="card-group">
                                    <div class="card">
                                        <form id="registro" name=form method="POST" action="UsuarioActualizar" >
                                            <div class="container-fluid">
                                                <div class="row">   
                                                    <input hidden="true" type="text" name="idpersona" value="<%=currentUser.getIdPersona()%>"  class="form-control">
                                                    <div class="col-md-10">
                                                        <label for="nombre"> Nombre: </label>
                                                        <input type="text" style="width:300px" name="nombre" value="<%=currentUser.getNombre()%>"  class="form-control" placeholder="Nombre">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="nombre"> Apellido paterno </label>
                                                        <input type="text" style="width:300px" name="apellidop" value="<%=currentUser.getApellidoP()%>" class="form-control" placeholder="Apellido Paterno">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="nombre"> Apellido Materno </label>
                                                        <input type="text" style="width:300px" name="apellidom" value="<%=currentUser.getApellidoM()%>" class="form-control" placeholder="Apellido Materno">
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="nombre"> tipo de documento </label>
                                                        <select name="tdoumento" value="<%=currentUser.getTipoDocumento()%>" class="form-control" aria-label="Default select example">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="ndoumento" value="<%=currentUser.getNroDocumento()%>" class="form-control" placeholder="Nro Documento" disabled>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="nombre"> Numero de celular: </label>
                                                        <input type="text" name="ncelular" value="<%=tel.getNrotelefono()%>" class="form-control" placeholder="Nro Celular" required>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="nombre"> Direccion: </label>
                                                        <input type="text" name="direccion" value="<%=currentUser.getDireccion()%>" class="form-control" placeholder="Direccion" required>
                                                    </div>
                                                    <div class="col-md-10">
                                                        <label for="nombre"> Correo </label>
                                                        <input type="text" name="correo" value="<%=currentUser.getCorreo()%>" class="form-control" placeholder="Correo" required>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="nombre"> Contraseña </label>
                                                        <input type="password" name="contrasena" value="<%=usu.getContraseña()%>" class="form-control" placeholder="Contraseña" required>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="nombre"> Contraseña Confirmar </label>
                                                        <input type="password" name="Confircontrasena" value="<%=usu.getContraseña()%>" class="form-control" placeholder="Confirmar Contraseña" required>
                                                    </div>
