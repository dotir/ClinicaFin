                              ...
                              <form id="registro" name=form method="POST" action="UsuarioActualizar" >
                                  <input hidden="true" type="text" name="idpersona" value="<%=currentUser.getIdPersona()%>"  class="form-control">
                                    <div class="form-group">
                                        <input type="text" name="nombre" value="<%=currentUser.getNombre()%>"  class="form-control" placeholder="Nombre">
                                   </div>
                                   <div class="form-group">
                                       <input type="text" name="apellidop" value="<%=currentUser.getApellidoP()%>" class="form-control" placeholder="Apellido Paterno">
                                   </div>
                                    <div class="form-group">
                                       <input type="text" name="apellidom" value="<%=currentUser.getApellidoM()%>" class="form-control" placeholder="Apellido Materno">
                                   </div>
                                   <div class="form-group">
                                   ...
                                   <div class="form-group">
                                       <input type="text" name="ndoumento" value="<%=currentUser.getNroDocumento()%>" class="form-control" placeholder="Nro Documento">
                                   </div>
                                   <div class="form-group">
                                       <input type="text" name="ncelular" value="<%=tel.getNrotelefono()%>" class="form-control" placeholder="Nro Celular">
                                   </div>
                                   <div class="form-group">
                                       <input type="text" name="direccion" value="<%=currentUser.getDireccion()%>" class="form-control" placeholder="Direccion">
                                   </div>
                                   <div class="form-group">
                                       <input type="text" name="correo" value="<%=currentUser.getCorreo()%>" class="form-control" placeholder="Correo">
                                   </div>
                                   <div class="form-group">
                                       <input type="password" name="contrasena" value="<%=usu.getContraseña()%>" class="form-control" placeholder="Contraseña">
                                   </div>
