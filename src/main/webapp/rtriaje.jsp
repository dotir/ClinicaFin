<%-- 
    Document   : rtriaje
    Created on : 09/07/2021, 03:33:38 AM
    Author     : ALESSO
--%>
        ...
        <nav class="sidebar">
            ...
            <ul id="sidebar_menu">
                ...
                <% persona currentUser = (persona) session.getAttribute("datospersona");
                 ...
                 String NomPac = (String) session.getAttribute("NomPac");
                    Gson gson = new Gson();
                %>
                                                            ...
                                                            <form id="registro" name=form method="POST" action="TriajeAgregar" >
                                                                <div class="container-fluid">
                                                                    <div class="row">
                                                                        ...
                                                                        <!--{'nombre':'Alessandro Pelayo','apellidosP':'Mollocondo','apellidoM':'Medrano','especialidad':'Cardiología'}-->
                                                                        <div class="col-md-6">
                                                                            <label for="idPersona12" >Numero de persona es: </label>
                                                                            <input type="hidden" style="width:50px" id="idPersona123" value="<%=Code%>" name="idPersona123" class="form-control" placeholder="idPersona123">
                                                                            <input type="text" style="width:50px" id="idPersona12" value="<%=Code%>" name="idPersona12" class="form-control" placeholder="idPersona" disabled>
                                                                            <label for="Nombre" >Nombre</label>
                                                                            <input type="text" style="width:300px" id="Nombre" name="Nombre" value="<%=NomPac%>" class="form-control" placeholder="Nombre" disabled>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                            <label for="idPClinica" >Codigo del personal</label>
                                                                            <input type="hidden" style="width:50px" id="idPClinica12" name="idPClinica12" value="<%=currentUser.getIdPersona()%>" class="form-control" placeholder="idPClinica12" >
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            ...
                                                                            <input type="number" style="width:150px" id="Edad" name="Edad" min="0" class="form-control" placeholder="Edad" required >
                                                                        </div>
                                                                        <div class="col-md-6">
