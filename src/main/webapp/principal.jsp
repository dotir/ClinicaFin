<%@page import="entidades.Triaje"%>
<%@page import="modelo.DaoTriaje"%>
                                        ...
                                        <div class="QA_section">
                                            ...
                                            <div class="QA_table mb_30">
                                                ...
                                                <table class="table lms_table_active">
                                                    ...
                                                    <tbody>                          
                                                        <%
                                                            DaoTriaje objcita = new DaoTriaje();

                                                            ArrayList<Triaje> objcitas = objcita.obtenerTriaje();
                                                            //                                                ArrayList<persona> objpersonas = objcita.obtenerDoctoresdet();
                                                        %>
                                                        <% for (int i = 0; i < objcitas.size(); i++) {%>
                                                        <tr>
                                                            <td><%=objcitas.get(i).getIdTriaje()%></td>
                                                            <td><%=objcitas.get(i).getNombrePac()%></td>
                                                            <td><%=objcitas.get(i).getEdad()%></td>
                                                            <td><%=objcitas.get(i).getPeso()%></td>
                                                            <td><%=objcitas.get(i).getSintomas()%></td>
                                                            <td><%=objcitas.get(i).getFecha()%></td>
