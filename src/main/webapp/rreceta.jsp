                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="modal-content cs_modal">
                                    ...
                                    <div class="modal-body">
                                        <form id="registrocita" name=formcita method="POST" action="RecetaAtenciond">
                                    
                                            
                                            <input hidden="true" type="text" value="<%= currentUser.getIdPersona()%>" name="idper" class="form-control" placeholder="Ingrese el detalle">
                                            <input hidden="true" type="text" value="<%= request.getParameter("idcli")%>" name="idc" class="form-control" placeholder="Ingrese el detalle">
                                            <div class="form-group">
                                                <input type="text"  name="Descripcion" class="form-control" placeholder="Ingrese el detalle">
                                            </div>
                                            <div class="form-group">
                                                <select name="tipore" class="form-control" aria-label="Default select example">
                                                     <option selected>Tipo receta</option>
                                            ...
                                            <div class="form-group">
                                                <select name="unidades" class="form-control" aria-label="Default select example">
