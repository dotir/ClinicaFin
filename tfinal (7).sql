...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-05-2021 a las 00:43:33
...
--
-- Estructura de tabla para la tabla `adjuntoreceta`
--

CREATE TABLE `adjuntoreceta` (
  `idAdjuntoReceta` int(11) NOT NULL,
  `Receta` blob DEFAULT NULL,
...
CREATE TABLE `atencion` (
  ...
  `idUsuarioClinica` int(11) NOT NULL,
...
INSERT INTO `atencion` (`idAtencion`, `idUsuarioClinica`, `idUsuarioCliente`, `FechaAtencion`, `FechaProgramada`, `Subtotal`, `IGV`, `Total`) VALUES
(1, 3, 7, '2021-05-21', '2021-05-21', '100.0000', '1.0000', '101.0000'),
(8, 2, 7, '2021-05-14', '2021-05-21', '100.0000', '1.0000', '101.0000'),
(11, 2, 7, '2021-05-21', '2021-05-22', '100.0000', '1.0000', '101.0000'),
(12, 2, 7, '2021-05-21', '2021-05-20', '100.0000', '1.0000', '101.0000'),
(13, 2, 7, '2021-05-21', '2021-05-28', '100.0000', '1.0000', '101.0000'),
(14, 2, 7, '2021-05-21', '2021-05-22', '100.0000', '1.0000', '101.0000'),
(15, 2, 7, '2021-05-21', '2021-05-22', '100.0000', '1.0000', '101.0000'),
(16, 2, 7, '2021-05-21', '2021-05-22', '100.0000', '1.0000', '101.0000'),
(17, 2, 7, '2021-05-21', '2021-05-22', '100.0000', '1.0000', '101.0000'),
(18, 2, 7, '2021-05-21', '2021-05-21', '100.0000', '1.0000', '101.0000'),
(19, 2, 7, '2021-05-21', '2021-05-22', '100.0000', '1.0000', '101.0000'),
(20, 1, 7, '2021-05-21', '2021-05-26', '100.0000', '1.0000', '101.0000');
...
INSERT INTO `detalleatencion` (`idDetalleAtencion`, `idAtencion`, `idTipoAtencion`, `idLocal`, `Detalle`, `HoraInicio`, `HoraFin`, `Precio`, `Estado`) VALUES
(1, 1, 1, 1, 'esta mal', '14:06:46', '15:06:46', '100.0000', 'activo'),
(3, 19, 2, 1, '', '13:00', '14:00', '101.0000', 'activo'),
(4, 20, 2, 2, '', '13:00', '14:00', '101.0000', 'activo');
...
--
-- Volcado de datos para la tabla `detalleventaservicio`
--

INSERT INTO `detalleventaservicio` (`idDetalleServicio`, `idVentaServicio`, `idMedicamento`, `Precio`, `Cantidad`) VALUES
(1, 1, 3, '100', '1');
...
INSERT INTO `direccion` (`ID_Direccion`, `Id_Dist`, `Descripcion`) VALUES
(1, 330, 'LA joya'),
(2, 4, 'calle siempre viva 123'),
(3, 330, 'LA joya'),
(4, 330, 'Socabaya'),
(5, 330, '4 de octubre'),
(6, 333, 'Cerro Viejo'),
(7, 330, '13 los olivos'),
(8, 333, 'calle siempre viva 123'),
(9, 331, 'calle 12'),
(10, 332, 'los olivos 123'),
(11, 334, 'la pradera 312'),
(12, 335, 'panoramico 221'),
(13, 337, 'redoblas 12'),
(14, 331, 'doscenter 32'),
(15, 342, 'patricio 54'),
(16, 341, 'los girasoles 96'),
(17, 343, 'celima87'),
(18, 330, 'su casa 123'),
(19, 330, 'av su casa 333'),
(20, 330, 'av.su casa 33322'),
(21, 330, 'av su casa 333'),
(22, 330, 'av.su casa 33322'),
(23, 330, '25872312');
...
CREATE TABLE `especialidad` (
  ...
  `idGrupoEspecialidad` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `especialidad` (`idEspecialidad`, `Nombre`, `Detalle`, `Costo`, `idGrupoEspecialidad`) VALUES
(1, 'Externo', 'Persona tomada como cliente ', '0.0000', 2),
(2, 'Cardiología', '', '11.0000', 1),
(3, 'Dermatología', 'a', '123.0000', 1),
(4, 'Alergología', 'diagnóstico y tratamiento de alérgias', '120.0000', 1),
(5, 'Cirugía de Cabeza y Cuello', '', '210510.0000', 1),
(6, 'Cirugía de Torax y Cardiovascular', '', '210510.0000', 1),
(7, 'Cirugía General y Laparoscópica', '', '210510.0000', 1),
(8, 'Cirugía Oncológica', '', '216510.0000', 1),
(9, 'Cirugía Pediátrica', '', '250510.0000', 1),
(10, 'Ecografía', '', '215410.0000', 1),
(11, 'Endocrinología', '', '460510.0000', 1),
(12, 'Gastroenterología', '', '560510.0000', 1),
(13, 'Geriatría', '', '320510.0000', 1),
(14, 'Ginecología Oncológica', '', '200510.0000', 1),
(15, 'Ginecología y Obstetricia', '', '210000.0000', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `grupoespecialidad`
--

CREATE TABLE `grupoespecialidad` (
  `idGrupoEspecialidad` int(11) NOT NULL,
  `NombreGrupo` varchar(45) NOT NULL,
  `DetalleGrupo` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `grupoespecialidad`
--

INSERT INTO `grupoespecialidad` (`idGrupoEspecialidad`, `NombreGrupo`, `DetalleGrupo`) VALUES
(1, 'Medica', NULL),
(2, 'Externo', 'grupo en el cual se encuentran las personas fuera de la clínica');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `grupomedicamento`
--
...
--
-- Volcado de datos para la tabla `grupomedicamento`
--

INSERT INTO `grupomedicamento` (`idGrupoMedicamento`, `Grupo`, `Detalle`) VALUES
(1, 'grupo1', 'ss');
...
CREATE TABLE `local` (
  ...
  `idDireccionLocal` int(11) DEFAULT NULL,
...
INSERT INTO `local` (`idLocal`, `idTipoLocal`, `idDireccionLocal`, `NombreLocal`) VALUES
(1, 1, 3, 'Local 1'),
(2, 1, 4, 'Local 2');
...
INSERT INTO `medicamento` (`idMedicamento`, `Nombre`, `Stock`, `Precio`, `idGrupoMedicamento`, `FechaVencimiento`) VALUES
(1, 'Ibuprofeno', '12', '12', 1, '2021-05-15 00:32:10'),
(2, 'Apronax', '100', '2.5', 1, '2021-05-05 07:42:23'),
(3, 'amoxicilina', '100', '2.5', 1, '2021-05-05 07:42:23');
...
INSERT INTO `persona` (`idPersona`, `Nombre`, `ApellidoPaterno`, `ApellidoMaterno`, `FechaNacimiento`, `TipoDocumento`, `NroDocumento`, `id_Direccion`, `Correo`, `Profesion`, `idEspecialidad`, `Estado`, `idTipoPersona`) VALUES
(1, 'Irving', 'Llerena', 'Bejarano', '1996-05-22', 'dni', '71641900', 1, 'irving@gmail.com', NULL, 4, 1, 1),
(2, 'Pedro', 'Martinez', 'Malaga', '1996-12-22', 'dni', '20562312', 2, 'pedro@gmail.com', NULL, 4, 1, 2),
(3, 'Alessandro Pelayo', 'Mollocondo', 'Medrano', '1995-06-16', 'dni', '72327552', 4, 'alesso@gmail.com', NULL, 2, 1, 2),
(65, 'Ale', 'Perez', 'Ortiz', '1996-02-17', 'dni', '45345112', 9, 'alpo@gmail.com', 'Ingeniero', 9, 1, 3),
(66, 'Jorge', 'Lopez', 'Hair', '1996-07-22', 'dni', '85345112', 8, 'jlha@gmail.com', 'Ingeniero', 6, 1, 3),
(67, 'Lili', 'Sordez', 'Jliri', '1996-04-12', 'dni', '94345112', 7, 'lisj@gmail.com', 'Ingeniero', 10, 1, 3),
(68, 'Yany', 'Quispe', 'Marquez', '1996-11-02', 'dni', '35345112', 8, 'yaqm@gmail.com', 'Ingeniero', 8, 1, 3),
(69, 'Jasmin', 'Lopez', 'Manrique', '1996-10-27', 'dni', '56345112', 9, 'jalm@gmail.com', 'Ingeniero', 8, 1, 3),
(70, 'Marysol', 'Illatupac', 'Quispe', '1996-05-01', 'dni', '68345112', 10, 'maiq@gmail.com', 'Ingeniero', 7, 1, 3),
(71, 'Zusima', 'Monti', 'Juarez', '1996-03-11', 'dni', '34345112', 11, 'zumj@gmail.com', 'Ingeniero', 2, 1, 3),
(72, 'Paolo', 'Pascal', 'Martin', '1996-01-02', 'dni', '56445112', 12, 'papm@gmail.com', 'Ingeniero', 4, 1, 3),
(73, 'Laura', 'Quiñonez', 'Farfan', '1996-02-14', 'dni', '85445112', 13, 'laqf@gmail.com', 'Ingeniero', 5, 1, 3),
(74, 'Yudith', 'Adrian', 'Supo', '1996-03-18', 'dni', '24545112', 14, 'yuas@gmail.com', 'Ingeniero', 8, 1, 3),
(75, 'Julissa', 'Laura', 'Sara', '1996-04-20', 'dni', '74145112', 15, 'juls@gmail.com', 'Ingeniero', 6, 1, 3),
(76, 'Dajhana', 'Molina', 'Quiñosa', '1996-11-01', 'dni', '74545112', 16, 'damq@gmail.com', 'Ingeniero', 5, 1, 2),
(77, 'Mauricio', 'Galvez', 'Galvez', '1996-12-22', 'dni', '71641898', 20, 'mauricio@gmail.com', NULL, NULL, 1, 3),
(78, 'Zareli', 'LLerena', 'Bejarano', '1996-12-22', 'dni', '71641896', 21, 'zareli@gmail.com', NULL, NULL, 1, 3),
(79, 'Marco', 'Delgado', 'Delgado', '1996-12-22', 'dni', '25872312', 22, 'marco12@gmail.com', NULL, NULL, 1, 3);
...
CREATE TABLE `telefono` (
  ...
  `Detalle(Propiedad)` varchar(15) NOT NULL,
  `idPersona` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `telefono` (`idTelefono`, `NroTelefono`, `Detalle(Propiedad)`, `idPersona`) VALUES
(1, '1234567', '', 1),
(2, '1234567', '', 2),
(3, '982312312', '', 78),
(4, '25872312', '', 79);
...
CREATE TABLE `tipoatencion` (
  `idTipoAtencion` int(11) NOT NULL,
  `TipoAtencion` varchar(30) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `tipoatencion` (`idTipoAtencion`, `TipoAtencion`) VALUES
(1, 'presencial'),
(2, 'virtual');
...
INSERT INTO `tipolocal` (`IdTipoLocal`, `Descripcion`) VALUES
(1, 'Clínica'),
(2, 'Farmacia'),
(3, 'Laboratorio');
...
INSERT INTO `tiporeceta` (`IDTipoReceta`, `Descripcion`) VALUES
(1, 'Examen'),
(2, 'Medicamento');
...
INSERT INTO `usuario` (`idUsuario`, `Nombre`, `Contrasena`, `idPersona`) VALUES
(1, 'Irving', '71641900', 1),
(2, 'Pedro', '20562312', 2),
(3, 'alesso', '72327552', 3),
(4, 'ale', '45345112', 65),
(5, 'Jorge', '85345112', 66),
(6, 'Mauricio', '71641898', 77),
(7, 'Zareli', '71641896', 78),
(8, 'Marco', '25872312', 79);
...
INSERT INTO `ventaservicio` (`idServicio`, `idUsuario`, `idEmpleado`, `IdLocal`, `Fecha`, `Total`, `Subtotal`, `Igv`) VALUES
(1, 2, 3, 1, '2021-05-21 09:08:20', '100.0000', '100.0000', NULL);
...
--
-- Indices de la tabla `adjuntoreceta`
--
ALTER TABLE `adjuntoreceta`
  ADD PRIMARY KEY (`idAdjuntoReceta`),
  ADD KEY `fk_AdjuntoReceta_VentaFarmacia1_idx` (`idFarmacia`);
...
ALTER TABLE `atencion`
  ...
  ADD KEY `fk_Atencion_Usuario1_idx` (`idUsuarioClinica`),
  ADD KEY `fk_Atencion_Persona1_idx` (`idUsuarioCliente`);
...
ALTER TABLE `detalleatencion`
  ...
  ADD KEY `fk_DetalleAtencion_Atencion1_idx` (`idAtencion`),
  ADD KEY `fk_DetalleAtencion_TipoAtencion1_idx` (`idTipoAtencion`),
  ADD KEY `fk_DetalleAtencion_Local1_idx` (`idLocal`);
...
ALTER TABLE `detalleventaservicio`
  ...
  ADD KEY `fk_DetalleFarmacia_Medicamento1_idx` (`idMedicamento`),
  ADD KEY `fk_DetalleVentaFarmacia_VentaFarmacia1_idx` (`idVentaServicio`);
...
ALTER TABLE `direccion`
  ...
  ADD KEY `direccion_ibfk_1` (`Id_Dist`);
...
ALTER TABLE `especialidad`
  ...
  ADD KEY `fk_Especialidad_GrupoEspecialidad1_idx` (`idGrupoEspecialidad`);

--
-- Indices de la tabla `grupoespecialidad`
--
ALTER TABLE `grupoespecialidad`
  ADD PRIMARY KEY (`idGrupoEspecialidad`);

--
-- Indices de la tabla `grupomedicamento`
--
ALTER TABLE `grupomedicamento`
  ADD PRIMARY KEY (`idGrupoMedicamento`);
...
ALTER TABLE `horario`
  ...
  ADD KEY `fk_Turnos_Especialidad1_idx` (`idEspecialidad`);
...
ALTER TABLE `local`
  ...
  ADD KEY `idDireccionLocal` (`idDireccionLocal`),
...
ALTER TABLE `medicamento`
  ...
  ADD KEY `fk_Medicamento_GrupoMedicamento1_idx` (`idGrupoMedicamento`);
...
ALTER TABLE `persona`
  ...
  ADD KEY `fk_Persona_Especialidad1_idx` (`idEspecialidad`),
...
ALTER TABLE `receta`
  ...
  ADD KEY `IdDetalleAtencion` (`IdDetalleAtencion`);
...
ALTER TABLE `telefono`
  ...
  ADD KEY `fk_Telefono_Cliente1_idx` (`idPersona`);
...
ALTER TABLE `ventaservicio`
  ...
  ADD KEY `fk_VentaFarmacia_Usuario1_idx` (`idUsuario`),
...
--
-- AUTO_INCREMENT de la tabla `adjuntoreceta`
--
ALTER TABLE `adjuntoreceta`
  MODIFY `idAdjuntoReceta` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `atencion`
--
ALTER TABLE `atencion`
  MODIFY `idAtencion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT de la tabla `detalleatencion`
--
ALTER TABLE `detalleatencion`
  MODIFY `idDetalleAtencion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `detalleventaservicio`
--
ALTER TABLE `detalleventaservicio`
  MODIFY `idDetalleServicio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT de la tabla `grupoespecialidad`
--
ALTER TABLE `grupoespecialidad`
  MODIFY `idGrupoEspecialidad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `grupomedicamento`
--
ALTER TABLE `grupomedicamento`
  MODIFY `idGrupoMedicamento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tipoatencion`
  MODIFY `idTipoAtencion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `tipolocal`
--
ALTER TABLE `tipolocal`
  MODIFY `IdTipoLocal` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tiporeceta`
  MODIFY `IDTipoReceta` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `atencion`
  ADD CONSTRAINT `atencion_ibfk_1` FOREIGN KEY (`idUsuarioCliente`) REFERENCES `usuario` (`idUsuario`),
  ADD CONSTRAINT `atencion_ibfk_2` FOREIGN KEY (`idUsuarioClinica`) REFERENCES `usuario` (`idUsuario`);

--
-- Filtros para la tabla `detalleatencion`
--
ALTER TABLE `detalleatencion`
  ADD CONSTRAINT `detalleatencion_ibfk_1` FOREIGN KEY (`idLocal`) REFERENCES `local` (`idLocal`),
  ADD CONSTRAINT `detalleatencion_ibfk_2` FOREIGN KEY (`idTipoAtencion`) REFERENCES `tipoatencion` (`idTipoAtencion`),
  ADD CONSTRAINT `fk_DetalleAtencion_Atencion1` FOREIGN KEY (`idAtencion`) REFERENCES `atencion` (`idAtencion`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `detalleventaservicio`
--
ALTER TABLE `detalleventaservicio`
  ADD CONSTRAINT `detalleventaservicio_ibfk_1` FOREIGN KEY (`idVentaServicio`) REFERENCES `ventaservicio` (`idServicio`),
  ADD CONSTRAINT `detalleventaservicio_ibfk_2` FOREIGN KEY (`idMedicamento`) REFERENCES `medicamento` (`idMedicamento`);

--
-- Filtros para la tabla `direccion`
--
ALTER TABLE `direccion`
  ADD CONSTRAINT `direccion_ibfk_1` FOREIGN KEY (`Id_Dist`) REFERENCES `ubdistrito` (`idDist`);

--
-- Filtros para la tabla `especialidad`
--
ALTER TABLE `especialidad`
  ADD CONSTRAINT `especialidad_ibfk_1` FOREIGN KEY (`idGrupoEspecialidad`) REFERENCES `grupoespecialidad` (`idGrupoEspecialidad`);

--
-- Filtros para la tabla `horario`
--
ALTER TABLE `horario`
  ADD CONSTRAINT `horario_ibfk_1` FOREIGN KEY (`idEspecialidad`) REFERENCES `especialidad` (`idEspecialidad`);

--
-- Filtros para la tabla `local`
--
ALTER TABLE `local`
  ADD CONSTRAINT `local_ibfk_2` FOREIGN KEY (`idTipoLocal`) REFERENCES `tipolocal` (`IdTipoLocal`),
  ADD CONSTRAINT `local_ibfk_3` FOREIGN KEY (`idDireccionLocal`) REFERENCES `direccion` (`ID_Direccion`);

--
-- Filtros para la tabla `medicamento`
--
ALTER TABLE `medicamento`
  ADD CONSTRAINT `medicamento_ibfk_1` FOREIGN KEY (`idGrupoMedicamento`) REFERENCES `grupomedicamento` (`idGrupoMedicamento`);

--
-- Filtros para la tabla `persona`
--
ALTER TABLE `persona`
  ADD CONSTRAINT `persona_ibfk_3` FOREIGN KEY (`idTipoPersona`) REFERENCES `tipopersona` (`idTipoPersona`),
  ADD CONSTRAINT `persona_ibfk_4` FOREIGN KEY (`idEspecialidad`) REFERENCES `especialidad` (`idEspecialidad`),
  ADD CONSTRAINT `persona_ibfk_5` FOREIGN KEY (`id_Direccion`) REFERENCES `direccion` (`ID_Direccion`);

--
-- Filtros para la tabla `receta`
--
ALTER TABLE `receta`
  ADD CONSTRAINT `receta_ibfk_2` FOREIGN KEY (`IdTipoReceta`) REFERENCES `tiporeceta` (`IDTipoReceta`),
  ADD CONSTRAINT `receta_ibfk_3` FOREIGN KEY (`IdDetalleAtencion`) REFERENCES `detalleatencion` (`idDetalleAtencion`);
...
--
ALTER TABLE `ubdistrito`
  ADD CONSTRAINT `ubdistrito_ibfk_1` FOREIGN KEY (`idProv`) REFERENCES `ubprovincia` (`idProv`);

--
-- Filtros para la tabla `ubprovincia`
--
ALTER TABLE `ubprovincia`
  ADD CONSTRAINT `ubprovincia_ibfk_1` FOREIGN KEY (`idDepa`) REFERENCES `ubdepartamento` (`idDepa`);
...
--
ALTER TABLE `ventaservicio`
  ADD CONSTRAINT `ventaservicio_ibfk_3` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`idUsuario`),
  ADD CONSTRAINT `ventaservicio_ibfk_4` FOREIGN KEY (`idEmpleado`) REFERENCES `usuario` (`idUsuario`),
  ADD CONSTRAINT `ventaservicio_ibfk_5` FOREIGN KEY (`IdLocal`) REFERENCES `local` (`idLocal`);
COMMIT;
